...
public class StringUtil {
	...
	public static boolean isCorrectUserName(String userName){
		...
		String sql = "select * from user where id = '%s' and password = '' or '1' = '1'";
	 ...
	 * 同时存在三种字符，强度为强(★️★️★️★★★)
	 * @param password
	 * @return 如果返回值为空字符串，那么密码的验证失败；验证成功，则返回星号表示密码的强度
	 */
	
	public static String validatePassword(String password){
		String power = "不合法";	//密码的强度
...
//					part.contains(Character.toString(value.charAt(i))))) {
//				return false;
//			}
//		}
//		return true;
